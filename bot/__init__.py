...
BOT_TOKEN = environ.get('BOT_TOKEN', '6970520093:AAFw3ih6RSIVQ-t3Mt_6PU9XlQfBwCIl2bQ')
if len(BOT_TOKEN) == 0:
...
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://a4771f658ed365:9Ufc2r3avwouPtfP@cluster0.ic4ipm1.mongodb.net/?retryWrites=true&w=majority')
...
OWNER_ID = environ.get('OWNER_ID', '6907837465')
if len(OWNER_ID) == 0:
...
TELEGRAM_API = environ.get('TELEGRAM_API', '24187232')
...
TELEGRAM_HASH = environ.get('TELEGRAM_HASH', '2eed6b8ede6d5069f70d6ea98e6f5785')
